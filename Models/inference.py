...
def main():
    ...
    # token = tokenizer('真不错，住在山里面真不错', padding='max_length', truncation=True, max_length=140)
    token = tokenizer(textt, padding='max_length', truncation=True, max_length=140)
