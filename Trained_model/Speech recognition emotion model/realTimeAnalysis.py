...
if __name__ == '__main__':
    classfier = joblib.load('E:\\firefoxdownload\\SpeechEmotionRecognition-master\\zwork\\Models\\C_13_mfccNum_48.m')
    ...
    if classfier:
        ...
        while True:
            ...
            path = now + ".wav"
            r.save_wave(path)
            #path = r'E:\firefoxdownload\SpeechEmotionRecognition-master\SpeechEmotionRecognition-master\casia\liuchanhg\angry\251.wav'
            # 提取声音特征
            ...
            labels = np.array(
                ['angry', 'anxious', 'happy', 'neutral', 'tired', 'surprise'])
